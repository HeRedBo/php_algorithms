...
├── Structure  ## 数据结构
│   ├── LinkedList 线性表表结构   
│   │   ├── CircularLinkedList.php  循环链表）
│   │   ├── DoubleLinkedList.php    双链表
│   │   └── SingleLinkedList.php    单链存储
│   ├── Queue     队列
│   │   ├── Deque.php  队列的数组实现（双向）
│   │   ├── Queue.php  队列的数组实现
│   │   └── QueueLinkedList.php 队列的链表实现
│   └── Stack  栈
│       ├── StackArray.php 栈的数组实现
│       └── StackLinkedList.php 栈的链表实现
├── other 其他
│   ├── demo01_array_sort.php php 二维数组排序算法 
│   ├── demo02_stairs_math.php    上楼梯次数的算法
│   ├── demo03_monkey_king.php    约瑟夫环 （猴子选大王）算法 
│   ├── demo04_object_array.php   对象可以像数组一样进行foreach 循环 基于 Itertator  实现
│   ├── demo05_deque.php   队列的数组实现（双向）
│   └── demo05_wash_card.php  php 洗牌算法 
├── php_query php 查找篇算法整理 
│   ├── demo01_sequence_query.php    php 顺序查找算法
│   ├── demo02_binary_query.php      二分查找
│   ├── demo03_insert_query.php      插入查找         
└── php_sort php排序算法的实现 
    ├── demo01_bubble_sort.php    冒泡排序
    ├── demo02_insert_sort.php    插入排序
    ├── demo03_quick_sort.php     快速排序
    ├── demo04_select_sort.php    选择排序
    ├── demo05_merge_sort.php     归并排序
    └── demo06_heap_sort.php      堆排序   
